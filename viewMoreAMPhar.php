...
<?php
  if(isset($_POST["submit"])){
    ...
    $pharid=$_POST["submit"];
    $result = mysqli_query($conn,"SELECT * FROM pharmacist WHERE pharmacist_id=$pharid");
              ...
              <form >
                  <div>
                    ...
                    <input type="text" name="registered_date" id="registered_date"  disabled="true" value="<?php echo $row["registered_date"] ?>">
                      ...
                      <button id="cBigButton" onclick="location.href='amPharmacist.php'" type="button">Go back</button>
