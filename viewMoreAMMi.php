...
<?php
  if(isset($_POST["submit"])){
    ...
    $miid=$_POST["submit"];
    $result = mysqli_query($conn,"SELECT * FROM meditation_instructor WHERE meditation_instructor_id=$miid");
      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <button id="cBigButton" onclick="location.href='amMeditationInstructor.php'" type="button">Go back</button>
