              ...
              while ($row = mysqli_fetch_array($result))
              {
                ...
                ?> <td>
                    <form  action="./includes/verifyN.inc.php" method="post">
                           <button class="buttonamU button1amU" value="<?php echo $row["requested_nutritionist_id"] ?>" name="verifyN">Verify</button>
                    </form>
                   </td>
                   <td>
                     <form action="./includes/NotverifyN.inc.php" method="post">
                           <button class="buttonamU button1amU" value="<?php echo $row["requested_nutritionist_id"] ?>" name="NotverifyN">Not Verify</button>
                    </form>
                  </td>
