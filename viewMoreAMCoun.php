...
<?php
  if(isset($_POST["submit"])){
    ...
    $counid=$_POST["submit"];
    $result = mysqli_query($conn,"SELECT * FROM counsellor WHERE counsellor_id=$counid");
              ...
              <form >
                  <div>
                    ...
                    <input type="text" name="registered_date" id="registered_date"  disabled="true" value="<?php echo $row["registered_date"] ?>">
                      ...
                      <button id="cBigButton" onclick="location.href='amCounsellor.php'" type="button">Go back</button>
