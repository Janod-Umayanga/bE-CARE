...
if(isset($_POST["submit"])){
       ...
       if($fileError===0){
           if($fileSize<100000000){
               ...
               move_uploaded_file($fileTmpName,$fileDestination);
                ...
                header("location:../Msignup.php?error=Your qualification file is too big!");
                exit();

           }
       }else{
              header("location:../Msignup.php?error=There was an error uploading file!");
              exit();

       }
    }else{
      header("location:../Msignup.php?error=You cannot upload files of this type!");
      exit();
    ...
    createUserRM($conn,$first_name,$last_name,$nic,$contact_number,$gender,$email,$password,$city,$address,$fee,$bank_name,$account_holder_name,$branch,$account_number,$fileDestination);
