...
<?php
  if(isset($_POST["submit"])){
    ...
    $counid=$_POST["submit"];
    $result = mysqli_query($conn,"SELECT * FROM requested_counsellor WHERE requested_counsellor_id=$counid");
      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <button id="cBigButton" onclick="location.href='rsCounsellor.php'" type="button">Go back</button>
