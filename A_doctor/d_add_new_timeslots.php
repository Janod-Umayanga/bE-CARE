<?php include("include_d/home_header.php") ?>
    ...
    <div class="mid">
        ...
        <div class="center_wrapper_mid">
            ...
            <div class="center">
                <form action="include/d_add_new_timeslot.inc.php" class="form_doctor_add_time" method = "post">
                    <div class = "input_2">

                        <div class="title">Add new time slots</div>

                        <label for="doctor_id">Doctor Id</label> <br> 
                        <input type="text" required = "true" name = "doctor_id"><br><br>
