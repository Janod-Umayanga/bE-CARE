<?php include("include_d/header.php") ?>

    <div class="mid">
        <div class="title">Signup as a Doctor</div> 
        <div class="center_wrapper_mid">
            <div class="left2">
                
            </div>
            <div class="center">
                <form action="include_d/signup.inc.php" class="form" method = "post">
                    ...
                    <div class = "form_right">
                        ...
                        <input type="text" name="type" required = "true"><br><br>

                        <label for="">Specialization</label><br>
                        <input type="text" name="specialization" required = "true"><br><br>
