...
<?php
  if(isset($_POST["submit"])){
    ...
    $nutid=$_POST["submit"];
    $result = mysqli_query($conn,"SELECT * FROM nutritionist WHERE nutritionist_id=$nutid");
              ...
              <form >
                  <div>
                    ...
                    <input type="text" name="fee" id="fee"  disabled="true" value="<?php echo $row["fee"] ?>">
                      ...
                      <button id="cBigButton" onclick="location.href='amNutritionist.php'" type="button">Go back</button>
