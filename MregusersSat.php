...
$result0 = mysqli_query($conn,"SELECT * FROM med_timeslot WHERE date>='$current_date' AND appointment_day='Saturday' ORDER BY date ASC ");
...
{  ?>
     ...
     <sectionc class="sMAdminAM">
      ...
      <?php
       ...
       {
           $se = $_GET['search'];
           $sql="SELECT * FROM med_timeslot WHERE date>='$current_date' AND appointment_day='Saturday' AND CONCAT(appointment_day,date,address, fee) LIKE '%$se%'";
