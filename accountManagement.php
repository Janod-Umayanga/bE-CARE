 ...
 <sectionc class="am">
   ...
   <h1>Account Management</h1>
     ...
     <div class="amcontent">
            ...
            <button class="buttonam button1am"><a href="amMeditationInstructor.php">Meditation Instructor</a></button>
            <button class="buttonam button1am"><a href="amPharmacist.php">Pharmacist</a></button>
            <button class="buttonam button1am"><a href="amAdmin.php">Admin</a></button>
