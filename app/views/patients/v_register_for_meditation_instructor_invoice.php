...
<?php require APPROOT.'/views/inc/components/header1.php'; ?>
    ...
    <section class="pay-section theme">
        <div class="pay-card theme">
            ...
            <form action="<?php echo URLROOT ?>/Payment/payforMeditationInstructorRegistration" method="POST">
                <input type="hidden" name="fee" value="<?php echo $data['fee'] ?>">
                <input type="hidden" name="meditation_instructor_id" value="<?php echo $data['meditation_instructor_id'] ?>">
                <input type="hidden" name="appointment_day_id" value="<?php echo $data['appointment_day_id'] ?>">
