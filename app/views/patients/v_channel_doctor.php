...
<body>
    <section class="login-section">
        ...
        <div class="login-page-rightside">
            <form action="<?php echo URLROOT ?>/Patient/channelDoctor/<?php echo $data['doctor_id'] ?>/<?php echo $data['channel_day_id'] ?>/<?php echo $data['date'] ?>/<?php echo $data['time'] ?>" method="POST">
