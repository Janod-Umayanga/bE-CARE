    ...
    <section class="login-section">
        <div class="login-page-leftside">
            <div class="left-side-container">
                <a href="<?php echo URLROOT ?>/Patient/findSession" class="page-change-button"><i class="fa-solid fa-arrow-left"></i>Back to Find a Session</a>
                <div>
                    <h1><i class="fa-solid fa-pills"></i> Be-Care</h1>
                    <h2>Enter your details</h2>
                    <p>Fill the relevant details needed for the session registration and click submit to proceed with the payment to complete the registration.</p>
                </div>
            </div>
        </div>
