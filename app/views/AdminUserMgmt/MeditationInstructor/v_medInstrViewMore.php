      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <button class="buttonamDownload button1amDownload"><a download="<?php echo $meditationInstructor->qualification_file ?>"  href="<?php echo URLROOT?>/upload/meditation_instructor_qualification/<?php echo $meditationInstructor->qualification_file ?>">Download</a></button>
                    ...
                    <button id="cBigButton" onclick="location.href='<?php echo URLROOT;?>/AdminUserMgmt/MeditationInstructor'" type="button">Go back</button>
