      ...
      <div class="cMed">
              ...
              <form action="<?php echo URLROOT;?>/AdminUserMgmt/addnewDoctor" method="post" enctype="multipart/form-data">
                  <div>
                      ...
                      <span class="form-invalid" style="color:red;"><?php echo $data['email_err']; ?></span>
                  ...
                  <div>
                    ...
                    <span class="form-invalid" style="color:red;"><?php echo $data['qualification_file_err']; ?></span>
                    ...
                    <input type="text" name="specialization" id="specialization"  required="true" >
