      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <button class="buttonamDownload button1amDownload"><a download="<?php echo $doctor->qualification_file ?>"  href="uploads/<?php echo $row['qualification_file'] ?>">Download</a></button>
                    ...
                    <button id="cBigButton" onclick="location.href='<?php echo URLROOT;?>/AdminReqSerProviders/adminReqDoctor'" type="button">Go back</button>
