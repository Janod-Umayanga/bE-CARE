      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <button class="buttonamDownload button1amDownload"><a download="<?php echo $counsellor->qualification_file?>"  href="uploads/<?php echo $counsellor->qualification_file ?>">Download</a></button>
                    ...
                    <button id="cBigButton" onclick="location.href='<?php echo URLROOT;?>/AdminReqSerProviders/adminReqCounsellor'" type="button">Go back</button>
