      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <button class="buttonamDownload button1amDownload"><a download="<?php echo $nutritionist->qualification_file ?>"  href="uploads/<?php echo $nutritionist->qualification_file ?>">Download</a></button>
                    ...
                    <button id="cBigButton" onclick="location.href='<?php echo URLROOT;?>/AdminReqSerProviders/adminReqNutritionist'" type="button">Go back</button>
