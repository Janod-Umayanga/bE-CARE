...
<head>
    ...
    <title>View Requested Nutritionist </title>
</head>
<body>
    ...
    <section class="view-profile-container-requestedSP theme">
        <div class="card">
            ...
            <div class="main-image">
                <a href="<?php echo URLROOT ?>/AdminReqSerProviders/adminReqNutritionist" class="backto-doctors"><i class="fa-solid fa-arrow-left"></i>Back to Requested Nutritionists</a>
