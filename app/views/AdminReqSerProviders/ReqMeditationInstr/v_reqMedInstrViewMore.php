...
<head>
    ...
    <title>View Requested Meditation Instructor </title>
</head>
<body>
    ...
    <section class="view-profile-container-requestedSP  theme">
        <div class="card">
            ...
            <div class="main-image">
                <a href="<?php echo URLROOT ?>/AdminReqSerProviders/adminReqMeditationInstructor" class="backto-doctors"><i class="fa-solid fa-arrow-left"></i>Back to Requested Meditation Instructors</a>
