      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <input type="text" name="slmc" id="slmc"  disabled="true" value="<?php echo $pharmacist->slmc_reg_number ?>" >



                    <label>Qualification File</label>
                    <button class="buttonamDownload button1amDownload"><a download="<?php echo $pharmacist->qualification_file ?>"  href="uploads/<?php echo $pharmacist->qualification_file ?>">Download</a></button>
                    ...
                    <button id="cBigButton" onclick="location.href='<?php echo URLROOT;?>/AdminReqSerProviders/adminReqPharmacist'" type="button">Go back</button>
