...
<head>
    ...
    <title>Add new Meditation Instructor</title>
</head>
<body>
    <section class="diet-plan-section">
        <div class="diet-plan-leftside">
            <div class="diet-left-side-container">
                <a href="<?php echo URLROOT ?>/AdminUserMgmt/MeditationInstructor" class="page-change-button-from-diet"><i class="fa-solid fa-arrow-left"></i>Back to MeditationInstructor</a>
                <div>
