    ...
    <section class="table-section-userMgmt theme">
        <div class="table-container theme">
            <div class="table-topic-main">
                <h1>Counsellor</h1>
                <button><a href="<?php echo URLROOT;?>/AdminUserMgmt/addnewCounsellor">Add New </a></button>
            </div>
            <div class="search-section">
                <div class="search-bar">
                 
                    <form class="searchForm" action="<?php echo URLROOT;?>/AdminUserMgmt/adminSearchCounsellor" method="GET">
                       <input type="text" name="search" value="<?php echo $data['search'] ?>"  placeholder="Filter counsellor by first name, last name, city">
            ...
            <div class="table">
                <table cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <?php if($counsellor->delete_flag==0): ?>
