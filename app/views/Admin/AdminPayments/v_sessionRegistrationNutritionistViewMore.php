    ...
    <section class="view-profile-container-adminPayment theme">
        <div class="card">
            ...
            <div class="main-image">
                ...
                <h1>Dr. <?php echo $data['sessionRegistration']->first_name ?> <br> <?php echo $data['sessionRegistration']->last_name ?></h1>
                <h3>Nutritionist</h3>
            </div>
            ...
            <div class="bottom">
                <ul> 
                    ...
                    <li>Nutritionist Fee - <?php echo ($data['sessionRegistration']->paid_amount/110)*100 ?></li>
                    ...
                    <li>Nutritionist Email - <a href="mailto:<?php echo $data['sessionRegistration']->email ?>"><?php echo $data['sessionRegistration']->email ?></a></li>
                    <li>Nutritionist Contact Number - <?php echo $data['sessionRegistration']->contact_number ?></li>
