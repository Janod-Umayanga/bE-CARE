...
<head>
    ...
    <title>View Counsellor Diet Plan </title>
</head>
<body>
        ...
        <div class="card">
            ...
            <div class="bottom">
                <ul> 
                    ...
                    <li>Counsellor Fee - <?php echo ($data['sessionRegistration']->paid_amount/110)*100 ?></li>
                    ...
                    <li>Counsellor Email - <a href="mailto:<?php echo $data['sessionRegistration']->email ?>"><?php echo $data['sessionRegistration']->email ?></a></li>
                    <li>Counsellor Contact Number - <?php echo $data['sessionRegistration']->contact_number ?></li>
