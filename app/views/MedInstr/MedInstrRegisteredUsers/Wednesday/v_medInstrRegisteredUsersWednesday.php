    ...
    <section class="table-section-MIRegUsers theme">
        <div class="table-container theme">
            <div class="table-topic-main">
                <h1>Wednesday Registered Users</h1>
            </div>
            ...
            <?php if(!empty($data['wednesday'])){ ?>

            <?php foreach($data['wednesday'] as $wednesday): ?>
                     
               <h1><?php echo $wednesday->date; ?> | <?php echo $wednesday->day; ?></h1>
                   <h4 style="color:Green;"><?php echo $wednesday->address; ?> | Rs.<?php echo $wednesday->fee; ?>  | Max no of participants: <?php echo $wednesday->noOfParticipants; ?></h4>
            ...
            <div class="table">
                ...
                <?php $gg=1; ?>
                    <?php foreach($data['medChannel'] as $medChannel): ?>
                     <?php if($wednesday->med_ins_appointment_day_id==$medChannel->med_ins_appointment_day_id){ ?>
                        <?php if($gg==1){ ?> 
                    <tr>
                        <th>Starting time</th>
                        <th>Ending time</th>
