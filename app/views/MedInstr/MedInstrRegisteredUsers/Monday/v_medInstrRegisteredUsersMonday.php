...
<body>
    ...
    <section class="table-section-MIRegUsers theme">
        <div class="table-container theme">
            ...
            <?php if(!empty($data['monday'])){ ?>

            <?php foreach($data['monday'] as $monday): ?>
                     
               <h1><?php echo $monday->date; ?> | <?php echo $monday->day; ?></h1>
                   <h4 style="color:Green;"><?php echo $monday->address; ?> | Rs.<?php echo $monday->fee; ?> | Max no of participants: <?php echo $monday->noOfParticipants; ?></h4>
            ...
            <div class="table">
                ...
                <?php $gg=1; ?>
                    <?php foreach($data['medChannel'] as $medChannel): ?>
                     <?php if($monday->med_ins_appointment_day_id==$medChannel->med_ins_appointment_day_id){ ?>
                        <?php if($gg==1){ ?> 
                    <tr>
                        <th>Starting time</th>
                        <th>Ending time</th>
