...
<body>
    ...
    <section class="table-section-MIRegUsers theme">
        <div class="table-container theme">
            ...
            <?php if(!empty($data['friday'])){ ?>

            <?php foreach($data['friday'] as $friday): ?>
                     
               <h1><?php echo $friday->date; ?> | <?php echo $friday->day; ?></h1>
                   <h4 style="color:Green;"><?php echo $friday->address; ?> | Rs.<?php echo $friday->fee; ?>  | Max no of participants: <?php echo $friday->noOfParticipants; ?></h4>
            ...
            <div class="table">
                ...
                <?php $gg=1; ?>
                    <?php foreach($data['medChannel'] as $medChannel): ?>
                     <?php if($friday->med_ins_appointment_day_id==$medChannel->med_ins_appointment_day_id){ ?>
                        <?php if($gg==1){ ?> 
                    <tr>
                        <th>Starting time</th>
                        <th>Ending time</th>
