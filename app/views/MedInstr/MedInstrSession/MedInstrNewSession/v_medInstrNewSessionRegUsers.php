...
<body>
    ...
    <section class="table-section-MISessionRegUsers theme">
        <div class="table-container theme">
            ...
            <div class="search-section">
                <div class="search-bar">
                    ...
                    <form class="searchform" action="<?php echo URLROOT;?>/MedInstrSession/searchMedInstrNewSessionRegUsers" method="GET">
