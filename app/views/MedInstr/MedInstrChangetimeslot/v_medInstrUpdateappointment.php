        ...
        <div class="diet-plan-leftside">
            <div class="diet-left-side-container">
                ...
                <div>
                    ...
                    <h2>Fill these details to update timeslot</h2>
                    <p>Click the "Update" button to save your changes and update timeslot.</p>
               </div>
            </div>
        </div>
        <div class="diet-plan-rightside">
            <form action="<?php echo URLROOT ?>/MedInstrChangeTimeslot/updateAppointmentDay/<?php echo  $data["appointment_day_id"] ?>" method="POST">
