            ...
            <div class="table">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><form action="<?php echo URLROOT ?>/CounsellorAppoinments/viewPatients/<?php echo $appoinments->counsellor_channel_day_id ?>" method="POST">
                            <button class="View-button">View</button>
                        </form></td>
                        <?php if($appoinments->active == 0): ?>
                            <td><form action="<?php echo URLROOT ?>/Counsellor/enableTimeslot/<?php echo $appoinments->counsellor_channel_day_id ?>">
                        ...
                        <?php else: ?>
                            <td><form action="<?php echo URLROOT ?>/Counsellor/disableTimeslot/<?php echo $appoinments->counsellor_channel_day_id ?>">
