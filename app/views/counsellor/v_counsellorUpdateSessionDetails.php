    ...
    <section class="diet-plan-section">
        <div class="diet-plan-leftside">
            <div class="diet-left-side-container">
                <a href="<?php echo URLROOT ?>/counsellorChangeSessionDetails/counsellorChangeSessionDetails" class="page-change-button-from-diet"><i class="fa-solid fa-arrow-left"></i>Back to Change Session Details</a>
                <div>
        ...
        <div class="diet-plan-rightside">
            <form action="<?php echo URLROOT ?>/counsellorChangeSessionDetails/counsellorupdateSessionDetails/<?php echo  $data['session_id']?>" method="POST">
                <div class="diet-form-inputs-and-buttons">
                    ...
                    <div class="right">
                        ...
                        <textarea name="description" id="description"  rows="6" cols="80" ><?php echo $data['description'] ?></textarea>
