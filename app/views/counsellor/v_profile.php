   ...
   <div id="notification-container"></div>
    ...
    <section class="diet-plan-section">
        ...
        <div class="diet-plan-rightside">
           ...
           <form action="<?php echo URLROOT ?>/Counsellor/edit_profile/<?php echo $_SESSION['counsellor_id'];?>" method="POST">
                
                <div class="">
                    <h1>Your Details</h1>
                    <p>Change Password<a href="<?php echo URLROOT ?>/Counsellor/changePassword"> Here</a></p>
                </div>
                  ...
                  <div class="diet-form-inputs-and-buttons">
                    ...
                    <div class="left"> 
                        ...
                        <input type="text" id="city" disabled='true' name="city" value="<?php echo $data['city'] ?>">
