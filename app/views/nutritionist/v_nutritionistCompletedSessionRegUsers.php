...
<body>
    ...
    <section class="table-section-NutritionistSessionRegUsers theme">
        <div class="table-container theme">
            ...
            <div class="search-section">
                <div class="search-bar">
                    ...
                    <form class="searchform" action="<?php echo URLROOT;?>/NutritionistSession/searchNutritionistCompletedSessionRegUsers/" method="GET">
