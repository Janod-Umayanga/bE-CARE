...
<?php
  if(isset($_POST["submit"])){
    ...
    $pharid=$_POST["submit"];
    $result = mysqli_query($conn,"SELECT * FROM requested_pharmacist WHERE requested_pharmacist_id=$pharid");
      ...
      <div class="cViewMAMDAA">
              ...
              <form >
                  <div>
                    ...
                    <input type="text" name="pharmacy_name" id="pharmacy_name"  disabled="true" value="<?php echo $row["pharmacy_name"] ?>">

                    <label>registration Date</label>
                    <input type="text" name="registered_date" id="registered_date"  disabled="true" value="<?php echo $row["registered_date"] ?>">


                    <button id="cBigButton" onclick="location.href='rsPharmacist.php'" type="button">Go back</button>
